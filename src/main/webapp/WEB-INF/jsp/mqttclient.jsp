...
<html class=" js flexbox canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths" lang="en"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="/mqtt_files/normalize.css">
    <link rel="stylesheet" href="/mqtt_files/style.css">
    <link rel="stylesheet" href="/mqtt_files/foundation.css">
    <link rel="stylesheet" href="/mqtt_files/jquery.minicolors.css">
    <link rel="stylesheet" href="/mqtt_files/jquery.fancybox.min.css">
    <!-- Piwik -->
    <script type="text/javascript" defer="" async="" src="/mqtt_files/piwik.js.下载"></script><script type="text/javascript">
        var _paq = _paq || [];
...
<div id="header">
    <div>
        <a href="https://www.hivemq.com/"><img id="headerlogo" src="/mqtt_files/logo.png"></a>
...
<script src="/mqtt_files/lodash.min.js.下载"></script>
<script src="/mqtt_files/jquery.fancybox.min.js.下载"></script>

<script src="/mqtt_files/foundation.min.js.下载"></script>
<script src="/mqtt_files/foundation.forms.min.js.下载"></script>
<script src="/mqtt_files/modernizr.min.js.下载"></script>
<script src="/mqtt_files/moment.min.js.下载"></script>
<script src="/mqtt_files/jquery.minicolors.min.js.下载"></script>
<script src="/mqtt_files/mqttws31.js.下载"></script>
<script src="/mqtt_files/encoder.js.下载"></script>
<script src="/mqtt_files/app.js.下载"></script>
